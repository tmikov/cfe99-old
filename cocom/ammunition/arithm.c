...
static void (*unsigned_integer_overflow_reaction) (void)
...
static void (*integer_overflow_reaction) (void)
  = default_arithmetic_overflow_reaction;
...
void
default_arithmetic_overflow_reaction (void)
{
}
...
(*set_unsigned_integer_overflow_reaction (void (*function) (void))) (void)
{
  ...
  result = unsigned_integer_overflow_reaction;
  unsigned_integer_overflow_reaction = function;
  return result;
}
...
void
(*set_integer_overflow_reaction (void (*function) (void))) (void)
{
  void (*result) (void);

  result = integer_overflow_reaction;
  integer_overflow_reaction = function;
  return result;
}
...
void
add_unsigned_integer (int size, const void *op1, const void *op2, void *result)
{
  assert (size > 0);
  overflow_bit
...
void
unsigned_integer_shift_right (int size, const void *operand, int bits,
                              void *result)
{
  int byte_number;
  unsigned byte;
  ...
  if (bits < 0)
    unsigned_integer_shift_left (size, operand, -bits, result);
  else
    {
      assert (size > 0);
      overflow_bit = 0;
...
void
integer_shift_right (int size, const void *operand, int bits, void *result)
{
  int byte_number;
  unsigned byte;
  unsigned carry;
  ...
  if (bits < 0)
    integer_shift_left (size, operand, -bits, result);
  else
    {
      assert (size > 0);
...
void
unsigned_integer_shift_left (int size, const void *operand, int bits,
                             void *result)
{
  int byte_number;
  unsigned byte;
  ...
  if (bits < 0)
    unsigned_integer_shift_right (size, operand, -bits, result);
  else
    {
      assert (size > 0);
      overflow_bit = 0;
...
void
integer_shift_left (int size, const void *operand, int bits, void *result)
{
  int byte_number;
  unsigned byte;
  unsigned carry;
  ...
  if (bits < 0)
    integer_shift_right (size, operand, -bits, result);
  else
    {
      assert (size > 0);
      operand_sign = INTEGER_SIGN (operand);
...
void
unsigned_integer_and (int size, const void *op1, const void *op2, void *result)
{
...
{
  const unsigned char *str1 = op1;
  const unsigned char *str2 = op2;
