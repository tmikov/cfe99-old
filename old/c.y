...
struct_or_union_specifier
  : struct_or_union declspec_list_opt any_identifier '{' struct_declaration_list '}'
  | struct_or_union declspec_list_opt                '{' struct_declaration_list '}'
  | struct_or_union declspec_list_opt any_identifier
  ;
